  ...
  if (isSubmitted) {
    return (
      <PageWrapper className="flex items-center justify-center py-12">
        <PageContainer variant="default" className="max-w-3xl">
          <Card>
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 mb-6">
                Thank you for reaching out. We read every message and most
                replies come within 24–48 hours.
              </p>
        ...
        <Card className="min-w-lg">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {isAuthenticated && user && (
              <p className="text-sm text-gray-500">Sending as {user.email}</p>
            )}
